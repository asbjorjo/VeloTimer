...
namespace VeloTime.Module.Timing.Migrations
{
    ...
    [Migration("20260531213936_AddLastSeenToInstallation")]
    partial class AddLastSeenToInstallation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VeloTime.Module.Timing.Model.TransponderOwner", b =>
                {
                    b.Property<Guid>("TransponderId")
                        .HasColumnType("uuid")
                        .HasColumnName("transponder_id");
                    ...
                    b.Property<DateTime?>("OwnedTo")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("owned_to");

                    b.HasKey("TransponderId", "OwnerId")
                        .HasName("pk_transponder_owner");

                    b.ToTable("transponder_owner", "timing");
                });
            ...
            modelBuilder.Entity("VeloTime.Module.Timing.Model.TransponderOwner", b =>
                {
                    b.HasOne("VeloTime.Module.Timing.Model.Transponder", "Transponder")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_transponder_owner_transponder_transponder_id");

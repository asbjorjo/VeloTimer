...
namespace VeloTime.IdentityProvider.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    user_id = table.Column<byte[]>(type: "bytea", nullable: true),
                    ...
                    cred_type = table.Column<string>(type: "text", nullable: true),
                    ...
                    descriptor_json = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("pk_fido_stored_credential", x => x.id);
                });

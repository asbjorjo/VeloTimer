...
namespace VeloTime.Storage.Migrations
{
    ...
    [Migration("20221228181738_ActiveLayout")]
    partial class ActiveLayout
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VeloTime.Storage.Models.Riders.Rider", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("VeloTime.Storage.Models.Riders.TransponderOwnership", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("VeloTime.Storage.Models.Statistics.Activity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("VeloTime.Storage.Models.Statistics.Session", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("VeloTime.Storage.Models.Statistics.StatisticsItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("VeloTime.Storage.Models.Statistics.TrackStatisticsItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("VeloTime.Storage.Models.Statistics.TransponderStatisticsItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("VeloTime.Storage.Models.Statistics.TransponderStatisticsLayout", b =>
                {
            ...
            modelBuilder.Entity("VeloTime.Storage.Models.Timing.Passing", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("VeloTime.Storage.Models.Timing.TrackSectorPassing", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("VeloTime.Storage.Models.Timing.TrackSectorSegmentPassing", b =>
                {
            ...
            modelBuilder.Entity("VeloTime.Storage.Models.Timing.TrackSegmentPassing", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("VeloTime.Storage.Models.Timing.Transponder", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("VeloTime.Storage.Models.TrackSetup.TimingLoop", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("VeloTime.Storage.Models.TrackSetup.Track", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("VeloTime.Storage.Models.TrackSetup.TrackLayout", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("VeloTime.Storage.Models.TrackSetup.TrackLayoutPassing", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("VeloTime.Storage.Models.TrackSetup.TrackLayoutSector", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("VeloTime.Storage.Models.TrackSetup.TrackSector", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("VeloTime.Storage.Models.TrackSetup.TrackSectorSegment", b =>
                {
                    b.Property<long>("SectorId")
                        .HasColumnType("bigint")
                        .HasColumnName("sector_id");
            ...
            modelBuilder.Entity("VeloTime.Storage.Models.TrackSetup.TrackSegment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("TrackLayoutPassingTrackSectorPassing", b =>
                {
                    b.HasOne("VeloTime.Storage.Models.TrackSetup.TrackLayoutPassing", null)
                        .WithMany()
                    ...
                    b.HasOne("VeloTime.Storage.Models.Timing.TrackSectorPassing", null)
                        .WithMany()
            ...
            modelBuilder.Entity("VeloTime.Storage.Models.Riders.TransponderOwnership", b =>
                {
                    b.HasOne("VeloTime.Storage.Models.Riders.Rider", "Owner")
                    ...
                    b.HasOne("VeloTime.Storage.Models.Timing.Transponder", "Transponder")
                        .WithMany("Owners")
            ...
            modelBuilder.Entity("VeloTime.Storage.Models.Statistics.Activity", b =>
                {
                    b.HasOne("VeloTime.Storage.Models.TrackSetup.Track", "Track")
                        .WithMany()
            ...
            modelBuilder.Entity("VeloTime.Storage.Models.Statistics.Session", b =>
                {
                    b.HasOne("VeloTime.Storage.Models.Statistics.Activity", "Activity")
                        .WithMany("Sessions")
            ...
            modelBuilder.Entity("VeloTime.Storage.Models.Statistics.TrackStatisticsItem", b =>
                {
                    b.HasOne("VeloTime.Storage.Models.TrackSetup.TrackLayout", "Layout")
                        .WithMany()
                    ...
                    b.HasOne("VeloTime.Storage.Models.Statistics.StatisticsItem", "StatisticsItem")
                        .WithMany()
            ...
            modelBuilder.Entity("VeloTime.Storage.Models.Statistics.TransponderStatisticsItem", b =>
                {
                    b.HasOne("VeloTime.Storage.Models.Statistics.TrackStatisticsItem", "StatisticsItem")
                        .WithMany()
                        .HasForeignKey("StatisticsItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("VeloTime.Storage.Models.Statistics.TransponderStatisticsLayout", b =>
                {
                    b.HasOne("VeloTime.Storage.Models.TrackSetup.TrackLayoutPassing", "LayoutPassing")
                        .WithMany()
                    ...
                    b.HasOne("VeloTime.Storage.Models.Statistics.TransponderStatisticsItem", "TransponderStatisticsItem")
            ...
            modelBuilder.Entity("VeloTime.Storage.Models.Timing.Passing", b =>
                {
                    b.HasOne("VeloTime.Storage.Models.TrackSetup.TimingLoop", "Loop")
                        .WithMany("Passings")
            ...
            modelBuilder.Entity("VeloTime.Storage.Models.Timing.TrackSectorPassing", b =>
                {
                    b.HasOne("VeloTime.Storage.Models.TrackSetup.TrackSector", "TrackSector")
                        .WithMany()
            ...
            modelBuilder.Entity("VeloTime.Storage.Models.Timing.TrackSectorSegmentPassing", b =>
                {
                    b.HasOne("VeloTime.Storage.Models.Timing.TrackSectorPassing", "SectorPassing")
                    ...
                    b.HasOne("VeloTime.Storage.Models.Timing.TrackSegmentPassing", "SegmentPassing")
                        .WithMany()
            ...
            modelBuilder.Entity("VeloTime.Storage.Models.Timing.TrackSegmentPassing", b =>
                {
                    b.HasOne("VeloTime.Storage.Models.Timing.Passing", "End")
                        .WithMany()
                        .HasForeignKey("EndId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                    ...
                    b.HasOne("VeloTime.Storage.Models.Timing.Passing", "Start")
                        .WithMany()
                    ...
                    b.HasOne("VeloTime.Storage.Models.TrackSetup.TrackSegment", "TrackSegment")
                        .WithMany()
            ...
            modelBuilder.Entity("VeloTime.Storage.Models.TrackSetup.TrackLayoutPassing", b =>
                {
                    b.HasOne("VeloTime.Storage.Models.TrackSetup.TrackLayout", "TrackLayout")
                        .WithMany()
            ...
            modelBuilder.Entity("VeloTime.Storage.Models.TrackSetup.TrackLayoutSector", b =>
                {
                    ...
                    b.HasOne("VeloTime.Storage.Models.TrackSetup.TrackSector", "Sector")
                        .WithMany()
            ...
            modelBuilder.Entity("VeloTime.Storage.Models.TrackSetup.TrackSectorSegment", b =>
                {
                    ...
                    b.HasOne("VeloTime.Storage.Models.TrackSetup.TrackSegment", "Segment")
                        .WithMany()
                    ...
                    b.HasOne("VeloTime.Storage.Models.TrackSetup.TrackSector", null)
                        .WithMany("Segments")
                        .HasForeignKey("TrackSectorId")
            ...
            modelBuilder.Entity("VeloTime.Storage.Models.TrackSetup.TrackSegment", b =>
                {
                    b.HasOne("VeloTime.Storage.Models.TrackSetup.TimingLoop", "End")
                        .WithMany()
                        .HasForeignKey("EndId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                    ...
                    b.HasOne("VeloTime.Storage.Models.TrackSetup.TimingLoop", "Start")
                        .WithMany()
                        .HasForeignKey("StartId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()

...
namespace VeloTimerWeb.Api.Services
{
    public interface ITransponderService
    {
        ...
        Task<PaginatedList<SegmentTime>> GetTimesForOwner(Rider rider, StatisticsItem statisticsItem, DateTimeOffset fromtime, DateTimeOffset totime, PagingParameters pagingParameters);
    }
}

...
namespace VeloTimerWeb.Api.Migrations.VeloTimer
{
    ...
    [Migration("20240225173556_StatisticsItemRider")]
    partial class StatisticsItemRider
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VeloTimerWeb.Api.Models.Statistics.TransponderStatisticsItem", b =>
                {
                    ...
                    b.HasIndex("RiderId")
                        .HasDatabaseName("ix_transponder_statistics_item_rider_id");
            ...
            modelBuilder.Entity("VeloTimerWeb.Api.Models.Statistics.TransponderStatisticsItem", b =>
                {
                    b.HasOne("VeloTimerWeb.Api.Models.Riders.Rider", "Rider")
                        .WithMany()
                        .HasForeignKey("RiderId")
                        .HasConstraintName("fk_transponder_statistics_item_rider_rider_id");
